...
export const ClassicFooter = ({ tokenSymbol, social, primaryColor, secondaryColor, accentColor }: ClassicFooterProps) => {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-3 mb-4">
              ...
              <span className="text-xl font-bold">{tokenSymbol}</span>
            </div>
