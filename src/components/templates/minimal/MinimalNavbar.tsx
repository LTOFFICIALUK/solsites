...
export const MinimalNavbar = ({ tokenSymbol, displayName, primaryColor, secondaryColor, logoUrl, navItems, cta, social, colors }: MinimalNavbarProps) => {
  const [isMenuOpen, setIsMenuOpen] = useState(false)

  return (
    <nav className="relative backdrop-blur-sm border-b border-gray-200" style={{ backgroundColor: colors?.navBgColor || 'rgba(255, 255, 255, 0.95)' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-3">
            ...
            {displayName && <span className="text-xl font-bold" style={{ color: colors?.tokenNameColor || '#111827' }}>{displayName}</span>}
          </div>
