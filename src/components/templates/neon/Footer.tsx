...
export const Footer = ({ tokenSymbol, social, primaryColor, secondaryColor, accentColor }: FooterProps) => {
  return (
    <footer className="bg-black/80 text-white py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-3 mb-4">
              ...
              <span className="text-xl font-bold neon-text">{tokenSymbol}</span>
            </div>
