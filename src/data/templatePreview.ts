...
export const templatePreviewData = {
  ...
  content: {
    ...
    about: {
      ...
      description: "Sample Token combines the fun of meme coins with real utility and strong fundamentals. Our community-driven approach ensures sustainable growth and long-term success.",
      features: [
        {
